...
function postNewRolesRoute(app) {
    return (pathName) => {
        ...
        folderRouter.put('/insert', Auth_1.adminRequired, controller.createRoles);
    };
}
exports.default = postNewRolesRoute;

//# sourceMappingURL=postNewRolesRoute.js.map
