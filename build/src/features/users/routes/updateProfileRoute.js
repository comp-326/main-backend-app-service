...
function updateAccountRoute(app) {
    return (pathName) => {
        ...
        userRouter.put('/account/profile/update/:id', Auth_1.loginRequired, controller.updateAccount);
    };
}
exports.default = updateAccountRoute;
